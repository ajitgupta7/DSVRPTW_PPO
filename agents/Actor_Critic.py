...
class Actor_Critic(nn.Module):
    def __init__(self,
        ...
        self.critic = Critic(customer_count, ff_size_critic)
        self.actor = GraphAttentionModel(customer_count, customer_feature, vehicle_feature, model_size, encoder_layer,
