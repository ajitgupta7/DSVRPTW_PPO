...
from problems import DSVRPTW_Environment
import numpy as np
...
class AgentPPO:
    def __init__(self,
        ...
        self.policy = Actor_Critic(customer_feature, vehicle_feature, customer_count, model_size,
                                   encoder_layer, num_head, ff_size_actor, ff_size_critic,
                                   tanh_xplor, greedy)
        self.old_policy = Actor_Critic(customer_feature, vehicle_feature, customer_count, model_size,
                                       encoder_layer, num_head, ff_size_actor, ff_size_critic,
                                       tanh_xplor, greedy)
    ...
    def update(self, memory, epoch, env=None, env_params=None, device=None):
        ...
        env = env if env is not None else DSVRPTW_Environment
