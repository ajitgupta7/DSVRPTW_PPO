...
class Critic(nn.Module):
    ...
    def __init__(self, customer_count, ff_size=512):
        super(Critic, self).__init__()
        self.ff_layer1 = nn.Linear(customer_count+1, ff_size, bias=False)
        self.ff_layer2 = nn.Linear(ff_size, customer_count+1, bias=False)
